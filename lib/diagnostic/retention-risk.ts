...
// Ideal duration per platform. TikTok (30s) and YouTube (480s / 8 min) are
// independently supported by sourced research: 30s clips get the highest
// TikTok engagement rate and sit inside the 21-34s max-completion range;
// YouTube "starts rewarding with higher suggested placement after minute 8."
// Instagram (20s) is a documented compromise — Reels between 7-15s get the
// highest retention (60-80%), but total watch time also matters, so a pure
// "shortest wins" number would be misleading. See
